...
page_title: "khulnasoft_image_assurance_policy Resource - terraform-provider-khulnasoft"
subcategory: ""
description: |-
  Khulnasoft Image Assurance covers the first part of the container lifecycle: image development. The Image Assurance subsystem detects, assesses, and reports security issues in your images.
---

# khulnasoft_image_assurance_policy (Resource)
