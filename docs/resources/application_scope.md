...
page_title: "khulnasoft_application_scope Resource - terraform-provider-khulnasoft"
subcategory: ""
description: |-
  
---

# khulnasoft_application_scope (Resource)
...
- `image` (Block Set) Name of a registry as defined in Khulnasoft (see [below for nested schema](#nestedblock--categories--artifacts--image))
