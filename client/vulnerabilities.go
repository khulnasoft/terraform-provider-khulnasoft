...
type Vulnerabilities struct {
	...
	KhulnasoftSeverityClassification string   `json:"khulnasoft_severity_classification"`
	KhulnasoftScoreClassification    string   `json:"khulnasoft_score_classification"`
