...
// Role represents a local Khulnasoft Role
type Role struct {
...
// GetRole - returns single Khulnasoft Role
...
// GetRoles - returns all Khulnasoft RoleList
...
// CreateRole - creates single Khulnasoft role
