...
func TestResourceKhulnasoftBasicContainerRuntimePolicyCreate(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: CheckDestroy("khulnasoft_container_runtime_policy.test"),
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "khulnasoft_container_runtime_policy.test",
				ImportState:       true,
...
func TestResourceKhulnasoftComplexContainerRuntimePolicyCreate(t *testing.T) {
	t.Parallel()
...
func containerRuntimePolicyRef(name string) string {
	return fmt.Sprintf("khulnasoft_container_runtime_policy.%v", name)
}
