...
func TestResourceKhulnasoftBasicHostRuntimePolicyCreate(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: CheckDestroy("khulnasoft_host_runtime_policy.test"),
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "khulnasoft_host_runtime_policy.test",
				ImportState:       true,
...
func TestResourceKhulnasoftComplexHostRuntimePolicyCreate(t *testing.T) {
	t.Parallel()
...
func hostRuntimePolicyRef(name string) string {
	return fmt.Sprintf("khulnasoft_host_runtime_policy.%v", name)
}
