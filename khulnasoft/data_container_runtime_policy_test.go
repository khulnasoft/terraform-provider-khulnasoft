...
func TestDataKhulnasoftBasicContainerRuntimePolicy(t *testing.T) {
	t.Parallel()
...
func TestDataKhulnasoftComplexContainerRuntimePolicy(t *testing.T) {
	t.Parallel()
...
func dataContainerRuntimePolicyRef(name string) string {
	return fmt.Sprintf("data.khulnasoft_container_runtime_policy.%v", name)
}
...
func getBasicContainerRuntimePolicyData(policy client.RuntimePolicy) string {
	...
	data "khulnasoft_container_runtime_policy" "test" {
		name = khulnasoft_container_runtime_policy.test.id
	}
