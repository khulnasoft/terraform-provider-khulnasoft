		...
		Steps: []resource.TestStep{
			{
				...
				Check:  testAccCheckApplicationScopePolicyDataSourceExists("data.khulnasoft_application_scope.defaultiap"),
			},
		},
	})
}
...
func testAccCheckApplicationScopePolicyDataSource(name string) string {
	...
	output "appscopes" {
		value = data.khulnasoft_application_scope.defaultiap
	}
	`, name)
